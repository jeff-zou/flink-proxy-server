...
public class NettyHttpResponse extends DefaultFullHttpResponse {
    ...
    private static final PooledByteBufAllocator BYTE_BUF_ALLOCATOR =
    ...
    private static final String CONTENT_ERROR_404 =
            "{\"code\":404,\"message\":\"REQUEST PATH NOT FOUND\"}";
    private static final String CONTENT_ERROR_405 =
    ...
    private NettyHttpResponse(HttpResponseStatus status, ByteBuf buffer) {
        ...
        headers()
                .set(
                        ...
                        "Origin, X-Requested-With, Content-Type, Accept, RCS-ACCESS-TOKEN");
    ...
    public static FullHttpResponse makeError(Exception exception) {
        ...
        return NettyHttpResponse.make(
                HttpResponseStatus.INTERNAL_SERVER_ERROR,
                String.format(CONTENT_ERROR_500, message));
    }

    public static FullHttpResponse ok(BaseResponse baseResponse) {
        String content = null;
        try {
    ...
    public String toString() {
        ...
        builder.append(protocolVersion().toString())
                .append(" ")
        ...
        builder.append(CONTENT_LENGTH)
                .append(": ")
                .append(headers().get(CONTENT_LENGTH))
                .append("\n");
